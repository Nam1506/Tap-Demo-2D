...
namespace Crystal
{
    ...
    public class SafeArea : MonoBehaviour
    {
        ...
        public static float topYOffset = 0;
        public static float botYOffset = 0;
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            if (Screen.width > 0 && Screen.height > 0)
            {
                ...
                //                Debug.Log(r.position + "_" + r.size.y);
                ...
                if (anchorMin.x >= 0 && anchorMin.y >= 0 && anchorMax.x >= 0 && anchorMax.y >= 0)
                {
                    ...
                    topYOffset = r.height - (Panel.anchorMax.y * r.height);
                    botYOffset = r.height * Panel.anchorMin.y;
                }
            }
